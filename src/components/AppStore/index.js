...
class AppStore extends Component {
  state = {activeTabId: tabsList[0].tabId, serachInput: ''}
  ...
  render() {
    ...
    const serachResults = filteredApps.filter(appp =>
      appp.appName.toLowerCase().includes(serachInput.toLowerCase()),
    )
